...
class KeepProgress():
    ...
    def train_progress(self,vals) :
        ...
        if vals['train_accuracy'] > dum2:
           self.train_best['accuracy'] = [vals['train_accuracy'], self.train_plots]
    ...
    def test_progress(self,vals) :
        ...
        if vals['test_accuracy'] >= dum2:
         self.test_best['accuracy'] = [vals['test_accuracy'], self.train_plots]

        print("test loss = {}, test accuracy = {}".format(vals['test_loss'], vals['test_accuracy']))

        if self.epochs%1 == 0: self.pickle_data()
