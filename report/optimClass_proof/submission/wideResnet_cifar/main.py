...
from progress_logger import KeepProgress
...
def main():
    ...
    def create_optimizer(args, lr):
        ...
        if args.optimizer == "RK2_momentum":
           optimizer = RK2(params.values(), lr=args.lr, momentum=args.momentum, weight_decay = args.wd)

        elif args.optimizer == "RK2":
           optimizer = RK2(params.values(), lr=args.lr, momentum=0.0, weight_decay = args.wd)

        elif args.optimizer == "RK2_heun":
           optimizer = RK2_heun(params.values(), lr=args.lr, momentum=0.0, weight_decay = args.wd)

        elif args.optimizer == "Adagrad":
            optimizer = optim.Adagrad(params.values(), lr=args.lr)

        elif args.optimizer == "SGD_nesterov":
            optimizer = optim.SGD(params.values(), lr=args.lr, momentum = args.momentum, nesterov=args.nesterov, weight_decay=args.wd)

        elif args.optimizer == "SGD_momentum" :
            optimizer = optim.SGD(params.values(), lr=args.lr, momentum = args.momentum, weight_decay=args.wd)

        elif args.optimizer == "SGD":
            optimizer = optim.SGD(params.values(), lr=args.lr, weight_decay=args.wd)
